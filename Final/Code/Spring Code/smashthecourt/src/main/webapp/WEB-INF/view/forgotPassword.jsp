...
<head>
  ...
  <title>Forgot Password - Smash The Court</title>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <main id="main">
    ...
    <!-- ======= forgot Section ======= -->
    <section data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500" class="d-flex justify-cntent-center align-items-center">

<div class="container">
<div class="col-md-8 offset-md-2">
  <div class="row" ><h3>Forgot Password Page</h3>
  
    <h5>Please enter your Email, Question, Answer. You will receive Password on your Email.</h5>
    
    
    <form:form method="POST" 
          action="ownerforgotpassword" modelAttribute="owner">
    ...
    <!-- <form action="#"> -->
      ...
      <div class="row">
        ...
        <div class="col-75">
          <select id="question" name="question">
            ...
            <!-- <option value="Favourite pet?">Favourite pet?</option>
      ...
      <div class="row">
        <div class="col-25">
          <br>
          <label for="questionAns"> Answer</label>
        </div>
        <div class="col-75">
          <input type="text" id="questionAns" name="questionAns" placeholder="Your answer..">
          </div>
      </div>
