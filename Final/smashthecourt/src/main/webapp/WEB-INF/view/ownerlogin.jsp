...
<html lang="en">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <form:form method="POST" action="ownerloginauthentication" modelAttribute="owner">    
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <span class="ml-auto"><a href="/ownerforgotpassword" class="forgot-pass">Forgot Password</a></span> 
            </div>

              <input type="submit" value="Log In" class="btn text-white btn-block btn-primary">
              <br>
             <a href="/ownerRegistration"><input type="button" value="Register Now" class="btn text-white btn-block btn-primary"></a>
             </form:form>
